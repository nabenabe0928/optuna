...
def _compute_standardized_regret_bound(
    ...
    ucb_acqf = acqf_module.UCB(gpr=gpr, search_space=search_space, beta=beta)
...
class RegretBoundEvaluator(BaseImprovementEvaluator):
    ...
    def evaluate(self, trials: list[FrozenTrial], study_direction: StudyDirection) -> float:
        ...
        # TODO(contramundum53): Add option to specify deterministic_objective.
        gpr.fit_kernel_params(self._log_prior, self._minimum_noise, deterministic_objective=False)
