...
def _exhaustive_search(
    ...
    fvals = acqf.eval_with_no_grad(all_params)
...
def _discrete_line_search(
    ...
    def negative_acqf_with_cache(i: int) -> float:
        ...
        # Flip sign because scipy minimizes functions.
        negval = -float(acqf.eval_with_no_grad(normalized_params))
...
def local_search_mixed(
    ...
    *,
    ...
    best_fval = float(acqf.eval_with_no_grad(best_normalized_params))
...
def optimize_acqf_mixed(
    ...
    *,
    ...
    f_vals = acqf.eval_with_no_grad(sampled_xs)
