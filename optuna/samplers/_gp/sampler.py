        ...
        if self._constraints_func is None:
            if n_objectives == 1:
                ...
                acqf_module.LogEHVI(
                    ...
                    search_space=internal_search_space,
                    X=normalized_params,
                    Y=standardized_score_vals,  # TODO: Refactor here.
            ...
            # function is ignored, so skipping the computation of gpr and acqf can improve speed.
            ...
            constraints_acqf_list = self._get_constraints_acqf_params(
